...
- Modify `src/discovery_agent/config/agents.yaml` to define your agents
- Modify `src/discovery_agent/config/tasks.yaml` to define your tasks
- Modify `src/discovery_agent/crew.py` to add your own logic, tools and specific args
- Modify `src/discovery_agent/main.py` to add custom inputs for your agents and tasks
...
This command initializes the discovery-agent Crew, assembling the agents and assigning them tasks as defined in your configuration.
...
For support, questions, or feedback regarding the DiscoveryAgent Crew or crewAI.
